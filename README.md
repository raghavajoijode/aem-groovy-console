...
1. [Download the console package](https://github.com/cid15/aem-groovy-console/releases/download/17.1.30/aem-groovy-console-all-17.1.30.zip).  For previous versions, tags can be checked out from GitHub and built directly from the source (e.g. `mvn install`).
